...
function toggleSize() {
  if (defaultView == true) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.circle').attr('r', d => (d.weekend * range / max) + baseSize);
    defaultView = false;
    simulation.force("collide", __WEBPACK_IMPORTED_MODULE_0_d3__["c" /* forceCollide */](d => (d.weekend * range / max) + baseSize + 1))
  } else {
    ...
    __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.circle').attr('r', d => baseSize + (d.sales / 3));
    defaultView = true;
    simulation.force("collide", __WEBPACK_IMPORTED_MODULE_0_d3__["c" /* forceCollide */](d => (d.sales / 3) + baseSize + 1))
  }
}
...
// helpers
  const hoverText = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]("body").append("div")
    .attr("class", "hover")
    .text("hoverText");
...
// dragging helpers
  function dragStart(d) {
    ...
    d.fx = d.x, d.fy = d.y;
    __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](this).raise().classed("active", true);
  }

  function dragged(d) {
    d.fx = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].x, d.fy = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].y;
  }

  function dragOver(d) {
    if (!__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].active) simulation.alphaTarget(0);
    d.fx = null, d.fy = null;
    __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](this).classed("active", false);
  }
...
//d3 function
  var svg = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]("body").append("svg")
    .attr("id", "chart")
    .attr("width", width)
    .attr("height", height)
    .attr('fill', 'blue')
...
// simulation
  simulation = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* forceSimulation */]()
  .force("x", __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* forceX */](center.x).strength(forceStrength))
  .force("y", __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* forceY */](center.y).strength(forceStrength))
  .force("collide", __WEBPACK_IMPORTED_MODULE_0_d3__["c" /* forceCollide */](d => (d.sales / 3) + baseSize + 1))
...
// draw circles
  var circles = svg.selectAll(".circle") //circle element
    ...
    .on("mousemove", () => {
      return hoverText
        .style("top", (__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].pageY+10)+"px")
        .style("left",(__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].pageX+10)+"px");
    })
    .on("mouseout", () => hoverText.style("visibility", "hidden"))
    .call(
      __WEBPACK_IMPORTED_MODULE_0_d3__["a" /* drag */]()
        .on("start", dragStart)
        .on("drag", dragged)
        .on("end", dragOver)
    )
    .on('click', d => {
      if (__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* event */].defaultPrevented) return;
